    ...
    <section className="py-14 md:py-20" style={{ backgroundColor: '#1A2A44' }}>
      <div className="mx-auto max-w-[800px] px-6 text-center">
        ...
        <p className="mx-auto mt-4 max-w-[560px] text-[16px] leading-relaxed text-white/80">
          G Reach out anytime to discuss your bookkeeping needs and tell us what you’re looking for! We’re here to answer questions, offer guidance, and help you explore your options - with no obligation.
        </p>
        <div className="mt-10">
          <Button
            asChild
