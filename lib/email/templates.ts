    ...
    <div class="content">
      ...
      <div class="signature">
        ...
        <div class="logo-section">
          <img src="https://tabber.ca/images/tabber-og2.png" alt="Tabber - Bookkeeping | Compliance | Advisory" width="250" style="display: block; margin-top: 15px; max-width: 100%; height: auto;">
        </div>
      </div>
    </div>
    <div class="footer">
