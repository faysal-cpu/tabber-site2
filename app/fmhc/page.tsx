            ...
            <div className="flex flex-col items-center gap-10 md:flex-row md:gap-16 md:items-stretch">
              <div className="flex-1 text-center md:text-left flex flex-col justify-between">
                <div>
                  ...
                  <h1 className="font-serif text-[30px] font-bold leading-[1.15] text-navy md:text-[44px]">Trusted Family-Managed Home Care Bookkeeping</h1>
                  <div className="mt-4">
          ...
          <div className="mx-auto max-w-[1200px] px-6">
            <div className="flex items-center gap-6 rounded-xl border-2 border-[#2B4C7E] bg-gradient-to-br from-[#E8EDF5] to-white p-6 md:p-8 shadow-sm">
              ...
              <div>
                ...
                <p className="text-[14px] leading-[1.7] text-muted-foreground">Your dedicated Bookkeeper meets all Schedule O qualification requirements under the FMHC program agreement, including CPA designation in good standing, professional liability insurance, National Payroll Institute membership, and a registered business number. We provide all the required documentation for submission to Ontario Health atHome.</p>
              </div>
            </div>
          </div>
        </section>
